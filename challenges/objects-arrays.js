...
const tRex = { name: "tyrannosaurus", diet: "carnivorous", weight: "7000kg", length: "12m", period: "Late Cretaceous", roar: ()=>{return `RAWERSRARARWERSARARARRRR!`} }
...
*/
let populationTotal = zooAnimals.reduce((total, accum)=>{
  return total+accum.population;
}, 0)
